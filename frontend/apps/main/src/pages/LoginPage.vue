 ...
 * Starts just below the slogan so the form floats on top of the deer pixel grid. */
.deer-canvas--deer {
  z-index: 1;
  top: calc(min(15vh, 60px) + 130px);
  height: calc(100vh - min(15vh, 60px) - 130px);
...
<style>
/* ─ Light mode overrides (must be unscoped — :global() inside scoped is stripped by Vue) ── */

[data-theme="light"] .login-page {
  background: #ffffff;
}

[data-theme="light"] .step0-subtitle,
[data-theme="light"] .pin-hint,
[data-theme="light"] .pin-display-name,
