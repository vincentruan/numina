export default {
  ...
  aiChat: {
    ...
    confirmDeleteSession: '⚠️ Delete this session?',
    deleteSessionSuccess: '🗑️ Session deleted',
    ...
    sessionNotFound: '⚠️ Session not found, please start a new chat',
  ...
  assetForm: {
    ...
    purchaseDateRequired: '⚠️ Please select purchase date',
    categoryRequired: '⚠️ Please select category',
    nameRequired: '⚠️ Please enter name',
    purchasePriceRequired: '⚠️ Please enter purchase price',
    currentValueRequired: '⚠️ Please enter current value',
  ...
  baby: {
    ...
    choreVoidSuccess: '🗑️ Task cancelled',
    ...
    wishRejectConfirmMsg: '⚠️ Are you sure you want to reject 「{name}」?',
  ...
  family: {
    ...
    confirmPromoteAdmin: '⚠️ Make "{name}" an admin?\n\nAdmins get full access to AI config, chore approvals, child management, etc.',
    confirmDemoteMember: '⚠️ Demote "{name}" to regular member?',
    confirmDisableAccount: '⚠️ Disable "{name}"\'s account? They will not be able to log in.',
    confirmEnableAccount: 'Enable "{name}"\'s account?',
    confirmRemoveMember2: '⚠️ Remove "{name}"? This cannot be undone.',
  ...
  auth: {
    ...
    form: {
      ...
      inviteCodeRequired: '⚠️ Please enter invite code',
      familyNameRequired: '⚠️ Please enter family name',
      usernameRequired: '⚠️ Please enter username',
      displayNameRequired: '⚠️ Please enter display name',
      passwordRequired: '⚠️ Please enter password',
      passwordMin8: '⚠️ Password must be at least 8 characters',
      passwordMin6: '⚠️ Password must be at least 6 characters',
      confirmPasswordRequired: '⚠️ Please confirm password',
      passwordMismatch: '⚠️ Passwords do not match',
    },
  },
  login: {
  ...
  toast: {
    ...
    aiTimeoutInvalid: '⚠️ Timeout must be an integer between 10 and 600 seconds',
  ...
  aiTask: {
    ...
    error: {
      ...
      deerflowTimeout: '⚠️ AI response timed out, please check model config or try again later',
      deerflowError: '⚠️ AI service execution failed, please try again later',
      agentCreateError: '⚠️ Agent creation failed, please check configuration',
      configBuildError: '⚠️ Runtime config build failed, please check AI settings',
      agentConfigError: '⚠️ Failed to get agent configuration',
      aiConfigError: '⚠️ Failed to get AI configuration',
      noProvider: '⚠️ No AI provider configured, please add one in settings',
      runtimeError: '⚠️ Agent runtime not ready',
      modelNotSupportReasoning: '⚠️ Current model does not support deep thinking mode',
      webSearchConfigError: '⚠️ Web search configuration error, please check settings',
    },
    retry: 'Retry',
  ...
  reminders: {
    ...
    chatIdInvalid: '⚠️ Chat ID must be numeric',
    channelNameRequired: '⚠️ Please enter channel name',
    chatIdRequired: '⚠️ Please enter Chat ID',
    smtpHostRequired: '⚠️ Please enter SMTP server',
  ...
  aiConfig: {
    ...
    confirmDeleteProvider: '⚠️ Delete "{name}"?',
  ...
  choreTemplate: {
    ...
    rewardLabel: 'Star reward',
    rewardPlaceholder: 'Enter star amount',
    rewardRequired: '⚠️ Please enter reward',
    ...
    deleteConfirm: '⚠️ Delete template "{name}"? Existing task instances will not be affected.',
    saveBtn: 'Save',
