export default {
  ...
  asrConfig: {
    ...
    pageDesc: 'Configure ASR models for voice input in AI chat (OpenAI / OpenAI-compatible only)',
    ...
    emptyDesc: 'Add an OpenAI-compatible ASR provider to enable voice input on devices without browser Speech API support',
