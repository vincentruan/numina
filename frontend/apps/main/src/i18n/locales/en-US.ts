export default {
  ...
  skills: {
    ...
    customPromptActive: '✏️ Custom prompt active',
    defaultPrompt: 'Using default prompt',
    promptHint: 'Leave empty to use the system default prompt. Changes take effect on next invocation.',
    enterPrompt: 'Enter custom prompt…',
    resetToDefault: 'Reset to Default',
    promptReset: '✅ Reset to default prompt',
    viewDefault: 'View default prompt',
    hideDefault: 'Hide default prompt',
    defaultPromptLabel: 'System default prompt (for reference)',
    capability: {
      report: '📊 Asset Health Report',
      chat: '💬 AI Chat Assistant',
      alerts: '🔔 Asset Alerts',
      allocation: '⚖️ Allocation Advice',
      disposal: '🗑️ Disposal Suggestions',
      liability: '💳 Liability Management',
      spending_leak: '🔍 Spending Leak Analysis',
      time_machine: '⏰ Time Machine Forecast',
    },
  },
  aiHub: {
