export default {
  ...
  aiChat: {
    ...
    confirmDeleteSession: '⚠️ Are you sure to delete this session?',
    deleteSessionSuccess: '🗑️ Session deleted',
    renameSessionSuccess: '✅ Renamed',
    renameSessionFailed: '❌ Rename failed, please retry',
    pinSessionSuccess: '✅ Pinned',
    unpinSessionSuccess: '✅ Unpinned',
    groupPinned: 'Pinned',
    groupToday: 'Today',
    groupYesterday: 'Yesterday',
    groupWeek: 'Within 7 days',
    groupMonth: 'Within 30 days',
    sessionNotFound: '⚠️ Session content not found, please start a new conversation',
    ...
    greetingTitle: 'Hi, I am Numina AI',
    greetingSubtitle: 'Ask me anything about family assets',
    suggestionAssetTotal: 'What is our net worth?',
    suggestionHighestCategory: 'Which asset category has the highest share?',
    suggestionIdleAssets: 'Which assets are idle?',
    suggestionNetWorthTrend: 'How is the net worth trend?',
  },
  asset: {
    title: 'Assets',
    all: 'All',
