export default {
  ...
  liability: {
    ...
    detailFieldStartDate: 'Start Date',
  ...
  aiAlerts: {
    ...
    dismiss: 'Dismiss',
    agingType: 'Expiring Soon',
    highMaintenanceType: 'High Maintenance',
    idleCostType: 'Idle Cost',
    remainingLife: 'Remaining Life: {days} days',
    dailyCost: 'Daily Cost: ¥{cost}/day',
    rescan: 'Rescan',
  },
  aiDisposal: {
    title: 'Idle Asset Disposal',
    pendingCount: '{count} assets pending disposal',
    dismiss: 'Dismiss',
    estimatedResale: 'Est. Resale: {range}',
    suggestedChannel: 'Suggested Channel: {channel}',
    dailyWaste: 'Daily Waste: ¥{cost}/day',
    rescan: 'Rescan',
  },
  aiAllocation: {
    title: 'Allocation Drift Detection',
    targetConfig: 'Target Allocation',
    currentTarget: 'Current Target',
    targetSet: 'Set',
    targetNotSet: 'Not Set',
    targetTotal: 'Total: {total}% (must equal 100%)',
    checkDrift: 'Check Drift',
    noDrift: 'Allocation is within target range, no rebalancing needed',
    aiNarrative: 'AI Recommendation',
    categoryDrifts: 'Category Drifts',
    targetToCurrent: 'Target {target}% → Current {current}%',
    categoryPhysical: 'Physical Assets',
    categoryFinancial: 'Financial Assets',
    categoryOther: 'Other',
  },
  aiLiability: {
    title: 'Liability Optimization Advisor',
  ...
  spendingLeaks: {
    ...
    dismiss: 'Dismiss',
    estimatedWaste: 'Estimated Annual Waste: ¥{amount}',
    leakTypeHighIdleCost: 'High Idle Cost',
    leakTypeRedundant: 'Redundant Holding',
    leakTypeHighMaintenance: 'High Maintenance Burden',
    severityHigh: 'High',
