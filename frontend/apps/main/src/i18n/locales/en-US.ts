export default {
  ...
  aiConfig: {
    ...
    visionModelIdLabel: 'Vision Model ID',
    visionModelPlaceholderAnthropic: 'e.g., claude-3-5-sonnet-20241022',
    visionModelPlaceholderOpenai: 'e.g., gpt-4o',
    timeoutLabel: 'API Timeout (seconds)',
    ...
    thinkingTest: 'Thinking Capability Test',
    visionTest: 'Vision Model Test',
    ocrTest: 'OCR Recognition Test',
    statusLabel: 'Status',
    ...
    statusThinkingSupport: '✅ Supports thinking',
    statusThinkingNoSupport: '❌ Not supported',
    statusOcrAccurate: '✅ OCR accurate',
    statusOcrFailed: '❌ OCR failed',
    providerAnthropic: '💬 Anthropic API Format',
    providerOpenai: '🤖 OpenAI API Format',
    providerNotSelected: 'Not selected',
    validationSelectProvider: 'Please select an AI Provider',
    validationApiKey: 'Please enter an API Key',
    validationModelId: 'Please enter a Model ID',
    testConnectionSuccess: '✅ Connection successful',
    testConnectionFailed: '❌ {message}',
    testThinkingSuccess: '🧠 Supports thinking capability',
    testThinkingFailed: '❌ {message}',
    testVisionSuccess: '✅ Vision model connected',
    testVisionFailed: '❌ {message}',
    testOcrSuccess: '✅ OCR recognition accurate',
    testOcrFailed: '❌ {message}',
  },
  spendingLeaks: {
    title: 'Spending Leak Detection',
    dismiss: 'Dismiss',
