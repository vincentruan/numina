export default {
  ...
  changeUsername: {
    ...
    submit: 'Confirm Change',
    confirmChange: 'Username can only be changed up to 3 times per month. Continue?',
    changeSuccess: 'Username has been changed',
    changeFailed: 'Change failed, please try again',
    usernameRequired: 'Please enter a username',
    usernameExists: 'This username is already taken',
    limitReached: 'Username can only be changed 3 times per month',
    limitHint: 'Up to 3 changes per month',
    remainingChanges: 'Change limit',
  },
  auth: {
    login: 'Login',
    register: 'Register',
