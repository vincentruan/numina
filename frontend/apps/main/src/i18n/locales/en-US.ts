export default {
  ...
  baby: {
    ...
    choreVoiding: 'Voiding...',
    voidChoreTitle: 'Void Task',
    voidChoreMessage: 'Void 「{name}」? It will not appear again today.',
    choreAssignSuccess: '✅ Assigned successfully',
    choreVoidSuccess: '🗑️ Task voided',
    choreAssignFailed: '❌ Assign failed, please try again',
    choreVoidFailed: '❌ Void failed, please try again',
