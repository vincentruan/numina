export default {
  ...
  captcha: {
    ...
    loadFailed: 'Captcha widget failed to load, please refresh',
    expired: 'Captcha expired, please verify again',
    devDisabled: 'Captcha disabled (dev mode)',
  },
  nav: {
    dashboard: 'Dashboard',
    assets: 'Assets',
  ...
  aiChat: {
    ...
    // U3: Shimmer thinking label
    thinkingLabel: 'Thinking...',
    thoughtSeconds: 'Thought for {seconds}s',
    // U6: Suggestion chips
    generatingResponse: 'Generating response...',
    suggestionsAria: 'Follow-up suggestions',
    suggestionPrefix: 'Suggested follow-up',
    // U4: Tool summary templates (displayed during execution)
    toolSummaryAssetQuery: 'Querying assets...',
    toolSummaryReportGen: 'Generating report...',
    toolSummaryTrendCalc: 'Calculating trend...',
    toolSummaryWishAnalysis: 'Analyzing wishes...',
    toolSummaryLiabilityAnalysis: 'Analyzing liabilities...',
    toolSummaryAllocationAnalysis: 'Analyzing allocation...',
    toolSummaryUnknown: 'Processing...',
    // U5: 2-tier input mode
    modeNormal: 'Normal',
    modeSmart: 'Smart',
    modeSmartLight: 'Light',
    modeSmartFull: 'Full',
    modeNormalDesc: 'Chat only, quick response',
    modeSmartDesc: 'Enable thinking + tool calls',
    modeSwitchConfirm: 'Switching mode will start a new chat. Current chat will be saved. Continue?',
    toolRunning: 'Running',
    toolDone: 'Done',
    toolFailed: 'Failed',
  ...
  skills: {
    ...
    form: {
      ...
      skillIdReserved: 'This ID is reserved for system use',
      ...
      skillPromptPlaceholderEdit: 'Leave empty to keep current prompt',
      createBtn: '+ New Skill',
