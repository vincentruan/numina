export default {
  ...
  baby: {
    ...
    choreApprove: '批准',
    choreRedo: '退回重做',
    choreApproveConfirm: '⚠️ 确定批准「{name}」？将获得积分奖励。',
    choreRedoConfirm: '⚠️ 确定退回「{name}」让孩子重做？',
    ...
    wishRejectConfirmMsg: '⚠️ 确定要拒绝「{name}」吗？',
  ...
  family: {
    ...
    enableAccount: '启用',
    resetPassword: '密码',
    confirmPromoteAdmin: '⚠️ 确定将「{name}」设为管理员？\n\n管理员将获得 AI 配置、家务审批、孩子管理等所有管理权限。',
    confirmDemoteMember: '⚠️ 确定将「{name}」降级为普通成员？',
    confirmDisableAccount: '⚠️ 确定禁用「{name}」的账户？禁用后该成员将无法登录。',
    confirmEnableAccount: '确定启用「{name}」的账户？',
    confirmRemoveMember2: '⚠️ 确定移除「{name}」？该操作不可撤销。',
  ...
  aiTask: {
    ...
    error: {
      ...
      deerflowTimeout: '⚠️ AI 响应超时，请检查模型配置或稍后重试',
      deerflowError: '⚠️ AI 服务执行失败，请稍后重试',
      agentCreateError: '⚠️ 智能体创建失败，请检查配置',
      configBuildError: '⚠️ 运行配置生成失败，请检查 AI 设置',
      agentConfigError: '⚠️ 获取智能体配置失败',
      aiConfigError: '⚠️ 获取 AI 配置失败',
      noProvider: '⚠️ 未配置 AI 供应商，请在设置中添加',
      runtimeError: '⚠️ Agent 运行环境未就绪',
      modelNotSupportReasoning: '⚠️ 当前模型不支持深度思考模式',
      webSearchConfigError: '⚠️ 联网搜索配置异常，请检查设置',
    },
    retry: '重试',
  ...
  aiReport: {
    ...
    conversionFailedButMarkdown: '⚠️ 报告内容已生成，但结构化解析失败',
