export default {
  ...
  aiChat: {
    ...
    thinkingLabel: '思考中...',
    thoughtSeconds: '思考了 {seconds}s',
    // U6: Suggestion chips
    generatingResponse: '正在生成回复...',
    suggestionsAria: '后续建议',
    suggestionPrefix: '建议追问',
    // U4: Tool summary templates (displayed during execution)
    toolSummaryAssetQuery: '正在查询资产...',
    toolSummaryReportGen: '正在生成报告...',
    toolSummaryTrendCalc: '正在计算趋势...',
    toolSummaryWishAnalysis: '正在分析心愿...',
    toolSummaryLiabilityAnalysis: '正在分析负债...',
    toolSummaryAllocationAnalysis: '正在分析配置...',
    toolSummaryUnknown: '正在处理...',
    // U5: 2-tier input mode
    modeNormal: '普通',
    modeSmart: '智能',
    modeSmartLight: '轻量',
    modeSmartFull: '完整',
    modeNormalDesc: '纯对话，快速响应',
    modeSmartDesc: '启用思考+工具调用',
    modeSwitchConfirm: '切换模式将开启新对话，当前对话将保存。是否继续？',
    toolRunning: '调用中',
    toolDone: '已完成',
    toolFailed: '调用失败',
    deepThinking: '深度思考中…',
  ...
  skills: {
    ...
    form: {
      ...
      skillPromptPlaceholderEdit: '留空则保持原提示词不变',
      createBtn: '+ 新增技能',
      updateBtn: '保存修改',
      createTitle: '新增技能',
      editTitle: '编辑技能',
