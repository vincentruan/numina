  ...
  >
    <div class="provider-sheet">
      <div class="provider-sheet__header">
        <span class="provider-sheet__title">{{ t('asrConfig.provider') }}</span>
      ...
      <div class="provider-sheet__list">
        ...
        >
          <div class="provider-item__icon" :class="`provider-item__icon--${provider.value}`">
            <!-- OpenAI logo -->
            <svg v-if="provider.value === 'openai'" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- SiliconFlow logo -->
            <svg v-else-if="provider.value === 'siliconflow'" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- OpenAI Compatible logo (with plug badge) -->
...
const providers = computed<ASRProviderOption[]>(() => [
  {
    value: 'openai',
    label: t('asrConfig.providerOpenAI'),
    subtitle: t('asrConfig.providerOpenAISubtitle'),
  },
  {
    value: 'openai_compatible',
    label: t('asrConfig.providerOpenAICompatible'),
    subtitle: t('asrConfig.providerOpenAICompatibleSubtitle'),
  },
  {
    value: 'siliconflow',
    label: t('asrConfig.providerSiliconFlow'),
    subtitle: t('asrConfig.providerSiliconFlowSubtitle'),
  },
])
...
/* SiliconFlow: indigo */
.provider-item__icon--siliconflow {
  background: color-mix(in srgb, #6366f1 12%, transparent);
  color: #6366f1;
}

[data-theme='dark'] .provider-item__icon--siliconflow {
