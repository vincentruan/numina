...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(), server_default=sa.func.now()),
        sa.UniqueConstraint('template_id', 'child_user_id', 'date_bucket',
    ...
    op.add_column('families', sa.Column('auto_approve_hours', sa.Integer(), nullable=False, server_default='24'))


def downgrade() -> None:
    op.drop_column('families', 'auto_approve_hours')
