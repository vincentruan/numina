...
| 脚本 | 说明 | 运行命令 |
|------|------|---------|
| `acceptance.sh` | 基础 API 验收测试（认证、资产、负债、心愿、仪表盘、家庭） | `./tests/e2e/scripts/acceptance.sh` |
| `extended.sh` | 扩展测试（CRUD、分类、标签、成员管理、快照） | `./tests/e2e/scripts/extended.sh` |
| `wishes-liabilities.sh` | 心愿和负债全字段专项测试 | `./tests/e2e/scripts/wishes-liabilities.sh` |
...
**位置：** `tests/tools/screenshot/capture.js`
...
**输出：** `tests/tools/screenshot/screenshots/`（17 个页面截图）
