...
export const PROTECTED_ROUTES: RouteEntry[] = [
  { name: 'Dashboard', path: '/' },
  { name: 'AssetAnalytics', path: '/dashboard/analytics' },
  ...
  { name: 'Baby', path: '/baby' },
  { name: 'BabyChoreCreate', path: '/baby/chores/new' },
  { name: 'ChoreTemplates', path: '/baby/chore-templates' },
  { name: 'ChoreTemplateEdit', path: '/baby/chore-templates/1/edit' },
  ...
  { name: 'AIProviderCreate', path: '/settings/ai/provider/new' },
  { name: 'AIProviderEdit', path: '/settings/ai/provider/1/edit' },
  { name: 'MCPManage', path: '/settings/ai/mcp' },
  { name: 'SkillsManage', path: '/settings/ai/skills' },
  { name: 'NotificationConfig', path: '/settings/notifications' },
  { name: 'NotificationThreshold', path: '/settings/notifications/threshold' },
