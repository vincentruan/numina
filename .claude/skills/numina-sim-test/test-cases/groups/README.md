...
| **G1** adult-stable | [`g1-adult-stable/`](./g1-adult-stable/) | area2, area3, area6, area7, area8, **area9**, **area12**, **area13**, **area14**, **area15**, area11 | `$SID` (adult) | reads global; per-entity writes only | **G3** |
...
```
        ┌── G1 (adult-stable: area2→area14→area8→area3→area6→area13→area12→area15→area9→area7→area11) ──┐
