...
class AIExtractionCircuit(Base):
    ...
    opened_until: Mapped[datetime | None] = mapped_column(UTCDateTime(), nullable=True)
    manually_reset_at: Mapped[datetime | None] = mapped_column(UTCDateTime(), nullable=True)
