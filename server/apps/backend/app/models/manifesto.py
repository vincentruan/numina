...
class FamilyManifesto(Base):
    ...
    signing_deadline: Mapped[datetime | None] = mapped_column(UTCDateTime(), nullable=True)
...
class ManifestoSignature(Base):
    ...
    signed_at: Mapped[datetime] = mapped_column(UTCDateTime(), server_default=func.now())
