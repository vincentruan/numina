"""Bootstrap category financial defaults (depreciation, return, lifespan)."""
...
def bootstrap_category_financial_defaults(db: Session) -> None:
    """Ensure category financial defaults exist. Idempotent."""
