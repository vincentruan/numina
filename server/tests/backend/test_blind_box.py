...
def test_compute_weights_basic():
    from apps.backend.app.services.blind_box import compute_weights
...
def test_pick_gift_returns_valid():
    from apps.backend.app.services.blind_box import pick_gift
...
def test_should_trigger_free_draw():
    from apps.backend.app.services.blind_box import should_trigger_free_draw
...
def test_is_special_day_birthday():
    ...
    from apps.backend.app.services.blind_box import is_special_day
